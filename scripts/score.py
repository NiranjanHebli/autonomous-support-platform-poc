...
def load_artifacts():
    try:
        ...
        with open("models/model_intent.pkl", "rb") as f:
            model_intent = pickle.load(f)
        with open("models/label_encoder_intent.pkl", "rb") as f:
            le_intent = pickle.load(f)

        with open("models/model_category.pkl", "rb") as f:
            model_category = pickle.load(f)
        with open("models/label_encoder_category.pkl", "rb") as f:
