...
def main():
    try:
        hf_token = ensure_env("HF_TOKEN", optional=True)
    ...
    dataset = load_dataset(
        "bitext/Bitext-customer-support-llm-chatbot-training-dataset", token=hf_token
    )
    ...
    for target in targets:
        ...
        # Save label encoder
        with open(f"models/label_encoder_{target}.pkl", "wb") as f:
